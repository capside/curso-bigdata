...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double resultado1E3 = Double.parseDouble(drpc.execute("montecarloPI", "1000"));
        double resultado1E7 = Double.parseDouble(drpc.execute("montecarloPI", "10000000"));
        
        System.out.println("RESULTADO 1000: ************ " + resultado1E3 + "(" + (resultado1E3 - Math.PI) + ")");
        System.out.println("RESULTADO 1000000: ************ " + resultado1E7 + "(" + (resultado1E7 - Math.PI) + ")");
        drpc.shutdown();
        cluster.shutdown();
    }
